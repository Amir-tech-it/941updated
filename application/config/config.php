...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
       $config['base_url'] =   $protocol.$_SERVER['HTTP_HOST'].'/941updated/';
}else{
...
'admin/Dashboard',
  ...
  'admin/Auth/logindash',
  'admin/logout',
  'admin/auth/logout',
  'admin/Campaigns/addcampaigns',
  'admin/Campaigns/deletecampaign',
  'admin/Campaigns/getedit',
  'admin/Campaigns/editcampaigns',
  'admin/Offers/addoffers',
  'admin/Offers/getedit',
  'admin/Offers/editoffer',
  'admin/Offers/deleteoffer',
	'home/checkout_process2',
	'admin/Offers/deleteImage',
	'admin/offers/offers_list',
	'apply/discount',
	'home/free_checkout_process',
	'get/notification',
	'home/new_prospect',
	'admin/add/user',
	'admin/user/delete',
